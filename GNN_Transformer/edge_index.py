...
def edge():
    ...
    cc_stations = [
        'NS24/NE6/CC1', 'CC2', 'CC3', 'CC4/DT15', 'CC5', 'CC6', 'CC7', 'CC8', 'EW8/CC9', 'CC10/DT26',
    ...
    dt_stations = [
        ...
        'DT10/TE11', 'NS21/DT11', 'NE7/DT12', 'DT13', 'EW12/DT14', 'CC4/DT15', 'DT16', 'DT17',
        'DT18', 'NE4/DT19', 'DT20', 'DT21', 'DT22', 'DT23', 'DT24', 'DT25', 'CC10/DT26', 
        'DT27', 'DT28', 'DT29', 'DT30', 'DT31', 'EW2/DT32', 'DT33', 'DT34', 'DT35'
    ]
    ...
    te_stations = [
        ...
        'DT10/TE11', 'TE12', 'TE13', 'TE14/NS22', 'TE15', 'TE16', 'EW16/NE3/TE17',
    ...
    all_stations = list(dict.fromkeys(bp_stations + cc_stations + dt_stations + ew_stations 
                                      + ne_stations + ns_stations + te_stations))
    ...
    all_edges = edges_bp + edges_cc + edges_dt + edges_ew + edges_ne + edges_ns + edges_te
